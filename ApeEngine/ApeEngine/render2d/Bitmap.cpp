...
bool Bitmap::Initialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int screenWidth, int screenHeight,
						int textureHeight, int textureWidth)
{
	...
	m_bitmapWidth = textureHeight;
	m_bitmapHeight = textureWidth;
