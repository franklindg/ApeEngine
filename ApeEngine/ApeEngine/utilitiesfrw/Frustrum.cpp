...
void Frustrum::Initialize(float screenDepth)
{
	m_screenDepth = screenDepth;
	return;
}

void Frustrum::ConstructFrustrum(XMFLOAT4X4 projectionMatrix, XMFLOAT4X4 viewMatrix)
{
	...
	finalMatrix = XMMatrixMultiply(XMLoadFloat4x4(&viewMatrix), XMLoadFloat4x4(&projectionMatrix));
...
bool Frustrum::CheckRectangle2(float maxWidth, float maxHeight, float maxDepth, float minWidth, float minHeight, float minDepth)
{
	int i;
	float dotProduct;
