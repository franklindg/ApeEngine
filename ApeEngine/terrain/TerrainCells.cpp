...
TerrainCells::TerrainCells(const TerrainCells& other)
{
...
bool TerrainCells::Initialize(ID3D11Device* device, void* terrainModelPtr, int nodeIndexX, int nodeIndexY,
...
void TerrainCells::Render(ID3D11DeviceContext* deviceContext)
{
	RenderBuffers(deviceContext);
	return;
}

int TerrainCells::GetVertexCount()
{
	return m_vertexCount;
}

int TerrainCells::GetIndexCount()
{
	return m_indexCount;
}

bool TerrainCells::InitializeBuffers(ID3D11Device* device, int nodeIndexX, int nodeIndexY, int cellHeight,
...
void TerrainCells::ShutdownBuffers()
{
	if (m_vertexList)
	{
		delete[] m_vertexList;
...
void TerrainCells::RenderBuffers(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
...
void TerrainCells::CalculateCellDimensions()
{
	int i;
...
bool TerrainCells::BuildLineBuffers(ID3D11Device* device)
{
...
void TerrainCells::ShutdownLineBuffers()
{
...
void TerrainCells::RenderLineBuffers(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
...
int TerrainCells::GetLineBuffersIndexCount()
{
	return m_lineIndexCount;
}

void TerrainCells::GetCellDimensions(float& maxWidth, float& maxHeight, float& maxDepth,
