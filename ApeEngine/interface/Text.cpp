...
bool Text::Initialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int screenWidth, int screenHeight, int maxLength,
	bool shadow, apeFont* font, char* text, int positionX, int positionY, float red, float green, float blue)
{
	bool result;
...
void Text::Render(ID3D11DeviceContext* deviceContext, ShaderManager* shaderManager, CXMMATRIX worldMatrix, CXMMATRIX viewMatrix,
	CXMMATRIX orthoMatrix, ID3D11ShaderResourceView* fontTexture)
{
...
bool Text::InitializeSentence(ID3D11Device* device, ID3D11DeviceContext* deviceContext, apeFont* font, char* text, int positionX,
...
bool Text::UpdateSentence(ID3D11DeviceContext* deviceContext, apeFont* font, char* text, int positionX, int positionY, float red,
...
void Text::RenderSentence(ID3D11DeviceContext* deviceContext, ShaderManager* shaderManager, CXMMATRIX worldMatrix, CXMMATRIX viewMatrix,
	CXMMATRIX orthoMatrix, ID3D11ShaderResourceView* fontTexture)
{
